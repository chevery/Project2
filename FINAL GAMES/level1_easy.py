...
class Game:
    ...
    def load_data(self):
       ...
       # font_name = path.join(font_name)
        #self.hud_font = path.join(font_name)
    ...
    def draw(self):
        ...
        if self.paused:
            ...
            self.draw_text("Are you afraid to continue?", font_name, 40, WHITE ,WIDTH/2, 600, align='center')
